...
data class ChatMetadataModel(
    ...
    {
        return "ChatID = $chatID, Name = $chatName, Chat Count = $chatMsgCount, Media Count = $mediaCount, Media Found = $mediaFound, Participants = $chatParticipants"
    }
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int)
    {
        ...
        parcel.writeInt(chatUserCount)
        parcel.writeInt(chatMsgCount)
